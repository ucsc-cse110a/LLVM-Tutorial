...
# llc -mtriple=$arch_triple -mattr=help
...
# or more commonly:
# clang -c file.s -target $arch_triple -o $file.o
# clang main.o callee_opt.o -o myprogram
#
# NOT POSITION INDEPENDENT LINKING:
# clang $file.o -no-pie -o $file
# 
# USING POSITION INDEPENDENT LINKING:
clang $file.o -o $file
#
